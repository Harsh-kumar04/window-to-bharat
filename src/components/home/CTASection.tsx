...
const CTASection = () => {
  ...
  const message = encodeURIComponent(
    "Hello! I would like to inquire about medical treatment options.",
  );
        ...
        <div className="max-w-3xl mx-auto text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            ...
            <Button
              ...
              size="lg"
              variant="outline"
              className="bg-[#c6c6c6] border-white   hover:bg-white/10 text-base px-8"
            >
          ...
          <p className="mt-6 text-white/70 text-sm">
            Or email us at{" "}
            <a
              href="mailto:info@medicareindia.com"
